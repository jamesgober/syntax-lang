...
<div align="left">
    <p>
        syntax-lang is the TOOL-tier crate: A lossless CST with trivia - the substrate for formatters, LSP, and tree-sitter generation. Part of the -lang language-construction family; see _strategy/LANG_COLLECTION.md for the master plan.
    </p>
    <br>
    <hr>
    <p>
